...
public class TestPlaceholderActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RandomSearchPlayer p1 = new RandomSearchPlayer(1);
        AbstractPlayer p2 = new RandomPlayer(2);

        FiveInARowBoard b = new FiveInARowBoard(8, 8, p1, p2);


        AbstractPlayer winner = p1.playRandomGameOnBoard(p1, b);

        Log.d(TAG, "winner: " + winner.getPlayerNumber() + ", " + winner.getName());
